...
struct WatchExampleApp: App {
  @State private var connection = WatchExampleConnection()
...
private final class WatchExampleConnection {
  ...
  func connect() async {
    ...
    do {
      let configuration = try ClerkConfiguration(
        ...
        callbackURL: URL(string: "com.clerk.WatchExampleApp://oauth/callback")!
      )
