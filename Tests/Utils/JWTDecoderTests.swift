...
struct JWTDecoderTests {
  ...
  @Test
  func jWTDecodeErrorInvalidBase64URL() {
  ...
  @Test
  func jWTClaimExtraction() throws {
    let body: [String: Any] = [
      "sub": "user123",
      "iss": "https://example.com",
  ...
  @Test
  func claimDate() throws {
    let timestamp = 1_609_459_200.0
