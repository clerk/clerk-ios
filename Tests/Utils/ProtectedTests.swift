...
struct ProtectedTests {
  ...
  @Test
  func testReadWithTransformation() {
  ...
  @Test
  func testWriteWithClosureReturningDifferentType() {
    let protected = Protected(10)
  ...
  @Test
  func testDynamicMemberLookupWritableKeyPath() {
    struct TestStruct {
      var name: String
      var age: Int
    }
  ...
  @Test
  func testDynamicMemberLookupReadOnlyKeyPath() {
    struct TestStruct {
      let name: String
      var age: Int
    }
