...
extension Clerk {
  ...
  @MainActor public static func connect(configuration: ClerkConfiguration, storage: (any CredentialStorage)? = nil, browser: AppleCapabilities.Presentation? = nil, passkeys: AppleCapabilities.Presentation? = nil) async throws -> Clerk {
    ...
    let capabilities = try AppleCapabilities(publishableKey: configuration.publishableKey, frontendAPI: configuration.frontendAPI, storage: storage, browser: browser, passkeys: passkeys)
