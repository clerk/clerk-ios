...
#Preview {
  ErrorView(
    error: PresentationError(message: "Similique qui enim placeat tempore. Labore voluptates aliquam est quaerat aut perferendis similique.", localizationBundle: .module),
    action: .init(
      text: "Call to action",
      action: {
