...
extension PasskeyHelper: ASAuthorizationControllerDelegate {
    ...
    public func authorizationController(controller: ASAuthorizationController, didCompleteWithAuthorization authorization: ASAuthorization) {
        ...
        case let credentialRegistration as ASAuthorizationPlatformPublicKeyCredentialRegistration:
            Logger.log(level: .info, scope: .auth, message: "A new passkey was registered: \(credentialRegistration)")
        ...
        case let credentialAssertion as ASAuthorizationPlatformPublicKeyCredentialAssertion:
            Logger.log(level: .info, scope: .auth, message: "A passkey was used to sign in: \(credentialAssertion)")
        ...
        case let passwordCredential as ASPasswordCredential:
            Logger.log(level: .info, scope: .auth, message: "A password was provided: \(passwordCredential)")
            ...
            continuation?.resume(returning: authorization)
        default:
          Logger.log(level: .info, scope: .auth, message: "Received unknown authorization type.")
        }
