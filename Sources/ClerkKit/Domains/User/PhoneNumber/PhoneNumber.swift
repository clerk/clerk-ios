...
extension PhoneNumber {
  ...
  public func sendCode() async throws -> PhoneNumber {
    try await Clerk.callResourceSteps(
      ...
      [
        ["pick": "phoneNumbers", "findId": id],
        ["method": "prepareVerification", "args": [String: String]()],
      ],
      as: PhoneNumber.self
    )
  }
  ...
  public func makeDefaultSecondFactor() async throws -> PhoneNumber {
    try await Clerk.callResourceSteps(
      ...
      [
        ["pick": "phoneNumbers", "findId": id],
        ["method": "makeDefaultSecondFactor", "args": [String: String]()],
      ],
      as: PhoneNumber.self
    )
  }
  ...
  public func setReservedForSecondFactor(reserved: Bool = true) async throws -> PhoneNumber {
    try await Clerk.callResourceSteps(
      ...
      [
        ["pick": "phoneNumbers", "findId": id],
        ["method": "setReservedForSecondFactor", "args": ["reserved": reserved]],
      ],
      as: PhoneNumber.self
    )
  }
