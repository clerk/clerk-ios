...
extension PhoneNumber {
  ...
  public func delete() async throws -> DeletedObject {
    try await Clerk.destroyPhoneNumber(id: id)
  }
  ...
  public func sendCode() async throws -> PhoneNumber {
    try await Clerk.preparePhoneNumberVerification(id: id)
  }
  ...
  public func verifyCode(_ code: String) async throws -> PhoneNumber {
    try await Clerk.attemptPhoneNumberVerification(id: id, code: code)
  }
  ...
  public func makeDefaultSecondFactor() async throws -> PhoneNumber {
    try await Clerk.makeDefaultPhoneNumberSecondFactor(id: id)
  }
  ...
  public func setReservedForSecondFactor(reserved: Bool = true) async throws -> PhoneNumber {
    try await Clerk.setPhoneNumberReservedForSecondFactor(id: id, reserved: reserved)
  }
}
