...
final class MockDependencyContainer: Dependencies {
  ...
  ///   - clientService: Optional custom client service (defaults to real ClientService with apiClient).
  ///   - userService: Optional custom user service (defaults to real UserService with apiClient).
  ///   - signInService: Optional custom sign-in service (defaults to real SignInService with apiClient).
  ///   - signUpService: Optional custom sign-up service (defaults to real SignUpService with apiClient).
  ///   - sessionService: Optional custom session service (defaults to real SessionService with apiClient).
  ///   - passkeyService: Optional custom passkey service (defaults to real PasskeyService with apiClient).
  ///   - organizationService: Optional custom organization service (defaults to real OrganizationService with apiClient).
  ///   - environmentService: Optional custom environment service (defaults to real EnvironmentService with apiClient).
  ///   - clerkService: Optional custom clerk service (defaults to real ClerkService with apiClient).
  ///   - emailAddressService: Optional custom email address service (defaults to real EmailAddressService with apiClient).
  ///   - phoneNumberService: Optional custom phone number service (defaults to real PhoneNumberService with apiClient).
  ///   - externalAccountService: Optional custom external account service (defaults to real ExternalAccountService with apiClient).
  init(
    apiClient: APIClient,
    ...
    // Use custom services if provided, otherwise create real services with apiClient
