...
public struct User: Codable, Equatable, Sendable, Identifiable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    primaryEmailAddressId = try container.decodeIfPresent(String.self, forKey: .primaryEmailAddressId)
    primaryPhoneNumberId = try container.decodeIfPresent(String.self, forKey: .primaryPhoneNumberId)
    primaryWeb3WalletId = try container.decodeIfPresent(String.self, forKey: .primaryWeb3WalletId)
    ...
    web3Wallets = try container.decode([Web3Wallet].self, forKey: .web3Wallets)
    externalAccounts = try container.decode([ExternalAccount].self, forKey: .externalAccounts)
    enterpriseAccounts = try container.decode([EnterpriseAccount].self, forKey: .enterpriseAccounts)
    passkeys = try container.decode([Passkey].self, forKey: .passkeys)
    organizationMemberships = try container.decode([OrganizationMembership].self, forKey: .organizationMemberships)
    ...
    totpEnabled = try container.decode(Bool.self, forKey: .totpEnabled)
    backupCodeEnabled = try container.decode(Bool.self, forKey: .backupCodeEnabled)
    ...
    unsafeMetadata = try container.decode(JSONValue.self, forKey: .unsafeMetadata)
    lastSignInAt = try container.decodeIfPresentMillisecondsDate(forKey: .lastSignInAt)
    createOrganizationEnabled = try container.decode(Bool.self, forKey: .createOrganizationEnabled)
    createOrganizationsLimit = try container.decodeIfPresent(Int.self, forKey: .createOrganizationsLimit)
    deleteSelfEnabled = try container.decode(Bool.self, forKey: .deleteSelfEnabled)
    legalAcceptedAt = try container.decodeIfPresentMillisecondsDate(forKey: .legalAcceptedAt)
