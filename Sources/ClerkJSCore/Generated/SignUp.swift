...
public struct SignUp: Codable, Equatable, Sendable, Identifiable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    requiredFields = try container.decode([String].self, forKey: .requiredFields)
    optionalFields = try container.decode([String].self, forKey: .optionalFields)
    missingFields = try container.decode([String].self, forKey: .missingFields)
    unverifiedFields = try container.decode([String].self, forKey: .unverifiedFields)
    ...
    externalAccountStrategy = try container.decodeIfPresent(String.self, forKey: .externalAccountStrategy)
    externalAccount = try container.decode(JSONValue.self, forKey: .externalAccount)
    ...
    abandonAt = try container.decodeIfPresentMillisecondsDate(forKey: .abandonAt)
    legalAcceptedAt = try container.decodeIfPresentMillisecondsDate(forKey: .legalAcceptedAt)
    locale = try container.decodeIfPresent(String.self, forKey: .locale)
    verifications = try container.decodeIfPresent(SignUpVerifications.self, forKey: .verifications)
    protectCheck = try container.decodeIfPresent(ProtectCheck.self, forKey: .protectCheck)
