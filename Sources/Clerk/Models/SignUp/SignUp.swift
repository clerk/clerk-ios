...
public extension SignUp {
  ...
  static func create(strategy: SignUp.CreateStrategy, legalAccepted: Bool? = nil) async throws -> SignUp {
...
extension SignUp {
  ...
  private var needsTransferToSignIn: Bool {
    verifications.contains { $0.key == "external_account" && $0.value?.status == .transferable }
  }
