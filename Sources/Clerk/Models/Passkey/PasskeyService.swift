...
struct PasskeyService {
  ...
  var update: (_ passkey: Passkey, _ name: String) async throws -> Passkey
  var attemptVerification: (_ passkey: Passkey, _ credential: String) async throws -> Passkey
  var delete: (_ passkey: Passkey) async throws -> DeletedObject
}
