...
struct PhoneNumberService {
  var delete: (_ phoneNumber: PhoneNumber) async throws -> DeletedObject
  var prepareVerification: (_ phoneNumber: PhoneNumber) async throws -> PhoneNumber
  var attemptVerification: (_ phoneNumber: PhoneNumber, _ code: String) async throws -> PhoneNumber
  var makeDefaultSecondFactor: (_ phoneNumber: PhoneNumber) async throws -> PhoneNumber
  var setReservedForSecondFactor: (_ phoneNumber: PhoneNumber, _ reserved: Bool) async throws -> PhoneNumber
}
