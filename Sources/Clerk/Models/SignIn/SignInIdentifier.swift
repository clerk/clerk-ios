...
///
/// The `SignInIdentifier` enum defines the types of identifiers that can be used during the sign-in process. Each identifier corresponds to a specific authentication method.
public enum SignInIdentifier: String, Codable, Sendable, Equatable, Hashable {
