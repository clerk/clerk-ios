...
public extension Factor {
  ...
  struct PasswordPrefComparator: SortComparator {
    ...
    public func compare(_ lhs: Factor, _ rhs: Factor) -> ComparisonResult {
      guard let order1 = strategySortOrderPasswordPref.firstIndex(of: lhs.strategy), let order2 = strategySortOrderPasswordPref.firstIndex(of: rhs.strategy) else {
        return .orderedSame
      }
  ...
  struct OtpPrefComparator: SortComparator {
    ...
    public func compare(_ lhs: Factor, _ rhs: Factor) -> ComparisonResult {
      guard let order1 = strategySortOrderOtpPref.firstIndex(of: lhs.strategy), let order2 = strategySortOrderOtpPref.firstIndex(of: rhs.strategy) else {
        return .orderedSame
      }
      return order1 < order2 ? .orderedAscending : .orderedDescending
    }
  ...
  struct BackupCodePrefComparator: SortComparator {
    ...
    public func compare(_ lhs: Factor, _ rhs: Factor) -> ComparisonResult {
      guard let order1 = strategySortOrderBackupCodePref.firstIndex(of: lhs.strategy), let order2 = strategySortOrderBackupCodePref.firstIndex(of: rhs.strategy) else {
        return .orderedSame
      }
      return order1 < order2 ? .orderedAscending : .orderedDescending
    }
  ...
  struct AllStrategiesButtonsComparator: SortComparator {
    ...
    public func compare(_ lhs: Factor, _ rhs: Factor) -> ComparisonResult {
      guard let order1 = strategySortOrderAllStrategies.firstIndex(of: lhs.strategy), let order2 = strategySortOrderAllStrategies.firstIndex(of: rhs.strategy) else {
        return .orderedSame
      }
      return order1 < order2 ? .orderedAscending : .orderedDescending
    }
