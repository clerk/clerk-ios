...
embedded-core evidence, but credential-rotation fencing remains unresolved.
...
TypeScript commit `2122fc015f`. These checks do not prove
device Keychain behavior; the platform storage suites cover that separate host
boundary. The remaining credential-rotation difference is a fixture
reproduction, not a claim about live server responses.
