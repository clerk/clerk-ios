...
| `constructingDisabledTransportDoesNotClearPendingPublication` | The new importer neither stages nor discards the old pending publication. Tests reject a changed/empty pending credential and accept the same credential; live publication convergence is unavailable. |
